...
# Use package_name instead of version=__version__ to avoid eagerly evaluating
# importlib.metadata during CLI startup. Click resolves package_name lazily when --version is passed.
